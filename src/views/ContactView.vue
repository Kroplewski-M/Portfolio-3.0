<template>
    <section class="w-[100vw] h-[300px] bg-[url('../assets/images/contact.jpg')] bg-contain pt-[60px]">
    ...
    <section class="w-[100vw] max-w-[1500px] h-[70vh] bg-[#1E1E1E] relative md:flex md:place-content-center">
